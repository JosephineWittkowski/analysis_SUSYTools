...
void TSelector_SusyNtuple::calc_EE_variables(Electron* el0, Electron* el1, TLorentzVector el0_TLV, TLorentzVector el1_TLV, TLorentzVector met_TLV, TLorentzVector signalJet0_TLV, TLorentzVector signalJet1_TLV, bool useForwardJets ){
...
void TSelector_SusyNtuple::calc_MM_variables(Muon* mu1, Muon* mu2, TLorentzVector mu0_TLV, TLorentzVector mu1_TLV, TLorentzVector met_TLV, TLorentzVector signalJet0_TLV, TLorentzVector signalJet1_TLV, bool useForwardJets){
  
  TLorentzVector mu0_TLV_n, mu1_TLV_n;
  mu0_TLV_n.SetPtEtaPhiE(mu1->pt, mu1->eta ,mu1->phi, mu1->pt*cosh(mu1->eta));
  mu1_TLV_n.SetPtEtaPhiE(mu2->pt, mu2->eta ,mu2->phi, mu2->pt*cosh(mu2->eta));
...
void TSelector_SusyNtuple::calc_EM_variables(Electron* el, Muon* mu, TLorentzVector mu_TLV, TLorentzVector el_TLV, TLorentzVector met_TLV, TLorentzVector signalJet0_TLV, TLorentzVector signalJet1_TLV, bool useForwardJets){
...
void TSelector_SusyNtuple::fillHistos_EE_SRSS1(float cut_EE, int mcid, float weight_ALL_EE){
  ...
  h_etal0_EE_SRSS1->Fill(eta_el0, cut_EE, weight_ALL_EE);  
  h_etal1_EE_SRSS1->Fill(eta_el1, cut_EE, weight_ALL_EE);  
  h_etaj0_EE_SRSS1->Fill(eta_j0, cut_EE, weight_ALL_EE);  
  h_etaj1_EE_SRSS1->Fill(eta_j1, cut_EE, weight_ALL_EE);  
...
void TSelector_SusyNtuple::fillHistos_EE_SRSS2(float cut_EE, int mcid, float weight_ALL_EE){
  ...
  h_etal0_EE_SRSS2->Fill(eta_el0, cut_EE, weight_ALL_EE);  
  h_etal1_EE_SRSS2->Fill(eta_el1, cut_EE, weight_ALL_EE);  
  h_etaj0_EE_SRSS2->Fill(eta_j0, cut_EE, weight_ALL_EE);  
  h_etaj1_EE_SRSS2->Fill(eta_j1, cut_EE, weight_ALL_EE);  
...
void TSelector_SusyNtuple::fillHistos_EE_SROS1(float cut_EE, int mcid, float weight_ALL_EE){
  ...
  h_etal0_EE_SROS1->Fill(eta_el0, cut_EE, weight_ALL_EE);  
  h_etal1_EE_SROS1->Fill(eta_el1, cut_EE, weight_ALL_EE);  
  h_etaj0_EE_SROS1->Fill(eta_j0, cut_EE, weight_ALL_EE);  
  h_etaj1_EE_SROS1->Fill(eta_j1, cut_EE, weight_ALL_EE);  
...
void TSelector_SusyNtuple::fillHistos_MM_SRSS1(float cut_MM, int mcid, float weight_ALL_MM){
  ...
  h_etal0_MM_SRSS1->Fill(eta_mu0, cut_MM, weight_ALL_MM);  
  h_etal1_MM_SRSS1->Fill(eta_mu1, cut_MM, weight_ALL_MM);  
  h_etaj0_MM_SRSS1->Fill(eta_j0, cut_MM, weight_ALL_MM);  
  h_etaj1_MM_SRSS1->Fill(eta_j1, cut_MM, weight_ALL_MM);  
...
void TSelector_SusyNtuple::fillHistos_MM_SRSS2(float cut_MM, int mcid, float weight_ALL_MM){
  ...
  h_etal0_MM_SRSS2->Fill(eta_mu0, cut_MM, weight_ALL_MM);  
  h_etal1_MM_SRSS2->Fill(eta_mu1, cut_MM, weight_ALL_MM);  
  h_etaj0_MM_SRSS2->Fill(eta_j0, cut_MM, weight_ALL_MM);  
  h_etaj1_MM_SRSS2->Fill(eta_j1, cut_MM, weight_ALL_MM);  
...
void TSelector_SusyNtuple::fillHistos_MM_SRSS3(float cut_MM, int mcid, float weight_ALL_MM){
  ...
  h_etal0_MM_SRSS3->Fill(eta_mu0, cut_MM, weight_ALL_MM);  
  h_etal1_MM_SRSS3->Fill(eta_mu1, cut_MM, weight_ALL_MM);  
  h_etaj0_MM_SRSS3->Fill(eta_j0, cut_MM, weight_ALL_MM);  
  h_etaj1_MM_SRSS3->Fill(eta_j1, cut_MM, weight_ALL_MM);  
...
void TSelector_SusyNtuple::fillHistos_MM_SRSS4(float cut_MM, int mcid, float weight_ALL_MM){
  ...
  h_etal0_MM_SRSS4->Fill(eta_mu0, cut_MM, weight_ALL_MM);  
  h_etal1_MM_SRSS4->Fill(eta_mu1, cut_MM, weight_ALL_MM);  
  h_etaj0_MM_SRSS4->Fill(eta_j0, cut_MM, weight_ALL_MM);  
  h_etaj1_MM_SRSS4->Fill(eta_j1, cut_MM, weight_ALL_MM);  
...
void TSelector_SusyNtuple::fillHistos_MM_SROS1(float cut_MM, int mcid, float weight_ALL_MM){
  ...
  h_etal0_MM_SROS1->Fill(eta_mu0, cut_MM, weight_ALL_MM);  
  h_etal1_MM_SROS1->Fill(eta_mu1, cut_MM, weight_ALL_MM);  
  h_etaj0_MM_SROS1->Fill(eta_j0, cut_MM, weight_ALL_MM);  
  h_etaj1_MM_SROS1->Fill(eta_j1, cut_MM, weight_ALL_MM);  
...
void TSelector_SusyNtuple::fillHistos_EM_SRSS1(float cut_EM, int mcid, float weight_ALL_EM){
  ...
  h_etal0_EM_SRSS1->Fill(eta_l0, cut_EM, weight_ALL_EM);  
  h_etal1_EM_SRSS1->Fill(eta_l1, cut_EM, weight_ALL_EM);  
  h_etaj0_EM_SRSS1->Fill(eta_j0, cut_EM, weight_ALL_EM);  
  h_etaj1_EM_SRSS1->Fill(eta_j1, cut_EM, weight_ALL_EM);  
...
void TSelector_SusyNtuple::fillHistos_EM_SRSS2(float cut_EM, int mcid, float weight_ALL_EM){
  ...
  h_etal0_EM_SRSS2->Fill(eta_l0, cut_EM, weight_ALL_EM);  
  h_etal1_EM_SRSS2->Fill(eta_l1, cut_EM, weight_ALL_EM);  
  h_etaj0_EM_SRSS2->Fill(eta_j0, cut_EM, weight_ALL_EM);  
  h_etaj1_EM_SRSS2->Fill(eta_j1, cut_EM, weight_ALL_EM);  
...
void TSelector_SusyNtuple::fillHistos_EM_SROS1(float cut_EM, int mcid, float weight_ALL_EM){
  ...
  h_etal0_EM_SROS1->Fill(eta_l0, cut_EM, weight_ALL_EM);  
  h_etal1_EM_SROS1->Fill(eta_l1, cut_EM, weight_ALL_EM);  
  h_etaj0_EM_SROS1->Fill(eta_j0, cut_EM, weight_ALL_EM);  
  h_etaj1_EM_SROS1->Fill(eta_j1, cut_EM, weight_ALL_EM);  
